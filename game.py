...
class dragon:
    ...
    def __init__(self):
        self.image=load_image("ImagesSprites/avion.png")
...
class flames:
    ...
    def __init__(self):
        self.image=load_image("ImagesSprites/missile.png")
        self.imagerect=self.image.get_rect()
...
class mario:
    ...
    downspeed=20
    def __init__(self):
        self.image=load_image("ImagesSprites/mouche.png")
        self.imagerect=self.image.get_rect()
...
pygame.display.set_caption("Missile War")
font=pygame.font.SysFont(None,48)
scorefont=pygame.font.SysFont(None,30)
#Images loads and creating rects

endobj=load_image('ImagesSprites/End1.png')
end=endobj.get_rect()
end.centery=height/2
end.centerx=width/2

startobj=load_image('ImagesSprites/Start1.png')
start=startobj.get_rect()
start.centerx=width/2
start.centery=height/2

cacbrickobj=load_image('ImagesSprites/spikewall2.png')
cacbrick=cacbrickobj.get_rect()

firebrickobj=load_image('ImagesSprites/spikewall1.png')
...
while True:
    flame_list=[]
    player=mario()#Creating object of mario class

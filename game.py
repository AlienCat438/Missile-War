...
class flames:
    ...
    def __init__(self):
        self.image=load_image("ImagesSprites/missile3.png")
        self.imagerect=self.image.get_rect()
...
class jet:
    ...
    downspeed=20
    def __init__(self):
        self.image=load_image("ImagesSprites/jet.png")
        self.imagerect=self.image.get_rect()
...
waitforkey()
topscore=0
Dragon=avion()#Creating object of dragon class

while True:
    flame_list=[]
    player=jet()#Creating object of mario class
